							...
							array(
								...
								'tasks' => array(
									array(
										...
										'href'            => PlanBrandUrls::resolve_task_link( 'corporate_setup_custom_domain' ),
										'status'          => 'new',
										'priority'        => 1,
										'source'          => 'wp-module-next-steps',
										'data_attributes' => array(
									...
									array(
										...
										'href'            => PlanBrandUrls::resolve_task_link( 'corporate_connect_google_business' ),
										'status'          => 'new',
										'priority'        => 3,
										'source'          => 'wp-module-next-steps',
										'data_attributes' => array(
									...
									array(
										...
										'href'            => PlanBrandUrls::resolve_task_link( 'corporate_create_branded_email' ),
										'status'          => 'new',
										'priority'        => 4,
										'source'          => 'wp-module-next-steps',
										'data_attributes' => array(
							...
							array(
								...
								'tasks' => array(
									...
									array(
										...
										'href'            => PlanBrandUrls::resolve_task_link( 'corporate_connect_search_console' ),
										'status'          => 'new',
										'priority'        => 2,
										'source'          => 'wp-module-next-steps',
										'data_attributes' => array(
							...
							array(
								...
								'tasks' => array(
									array(
										...
										'href'            => PlanBrandUrls::resolve_task_link( 'corporate_add_contact_form' ),
										'status'          => 'new',
										'priority'        => 1,
										'source'          => 'wp-module-next-steps',
										'data_attributes' => array(
									...
									array(
										...
										'href'            => PlanBrandUrls::resolve_task_link( 'corporate_embed_map' ),
										'status'          => 'new',
										'priority'        => 2,
										'source'          => 'wp-module-next-steps',
										'data_attributes' => array(
							...
							array(
								...
								'tasks' => array(
									...
									array(
										...
										'href'            => PlanBrandUrls::resolve_task_link( 'corporate_optimize_key_pages' ),
										'status'          => 'new',
										'priority'        => 3,
										'source'          => 'wp-module-next-steps',
										'data_attributes' => array(
									...
									array(
										...
										'href'            => PlanBrandUrls::resolve_task_link( 'corporate_generate_submit_sitemap' ),
										'status'          => 'new',
										'priority'        => 4,
										'source'          => 'wp-module-next-steps',
										'data_attributes' => array(
							...
							array(
								...
								'tasks' => array(
									array(
										...
										'href'            => PlanBrandUrls::resolve_task_link( 'corporate_setup_email_capture' ),
										'status'          => 'new',
										'priority'        => 1,
										'source'          => 'wp-module-next-steps',
										'data_attributes' => array(
									...
									array(
										...
										'href'            => PlanBrandUrls::resolve_task_link( 'corporate_connect_crm' ),
										'status'          => 'new',
										'priority'        => 2,
										'source'          => 'wp-module-next-steps',
										'data_attributes' => array(
									...
									array(
										...
										'href'            => PlanBrandUrls::resolve_task_link( 'corporate_add_cta_section' ),
										'status'          => 'new',
										'priority'        => 3,
										'source'          => 'wp-module-next-steps',
										'data_attributes' => array(
							...
							array(
								...
								'tasks' => array(
									...
									array(
										...
										'href'            => PlanBrandUrls::resolve_task_link( 'corporate_install_security_plugin' ),
										'status'          => 'new',
										'priority'        => 3,
										'source'          => 'wp-module-next-steps',
										'data_attributes' => array(
							...
							array(
								...
								'tasks' => array(
									...
									array(
										...
										'href'            => PlanBrandUrls::resolve_task_link( 'corporate_run_speed_test' ),
										'status'          => 'new',
										'priority'        => 2,
										'source'          => 'wp-module-next-steps',
										'data_attributes' => array(
									...
									array(
										...
										'href'            => PlanBrandUrls::resolve_task_link( 'corporate_plan_next_content' ),
										'status'          => 'new',
										'priority'        => 4,
										'source'          => 'wp-module-next-steps',
										'data_attributes' => array(
